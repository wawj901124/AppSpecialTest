...
class TestHome(unittest.TestCase):  # 创建测试类
    ...
    #登录的测试方法
    def defineclickandback(self,outtestcasediscription=None,ishomeorme=None,outclickelementtext=None):
    ...
    @unpack
    def test_clickandback(self,outtestcasediscription,ishomeorme,outclickelementtext):
        self.defineclickandback(outtestcasediscription,ishomeorme,outclickelementtext)
