...
class Controller(object):
    ...
    def RunMore(self):
        ...
        while self.counter>0:  #  如果次数大于0
            ...
            gettimestr.outPutMyLog("fps统计剩余运行次数为：%s" % self.counter)
    ...
    def SaveDataToCSV(self,timestr):
        ...
        csvfile = "%s/%s_%s" % (nyrsfmdir,timestr,AppFpsCSVFile)
        opencsvfile = open(csvfile, "w",newline="",encoding='utf-8') #加入newline=""，解决python3写入csv出现空白行
