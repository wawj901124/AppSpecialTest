...
class Controller(object):
    ...
    def TestProcessOnce(self):
        ...
        self.elapsedtimecold.append(elapsedtimecold)
        self.elapsedtimehot.append(elapsedtimehot)
    ...
    def SaveDataToCSV(self):
        ...
        csvfile = "./../dataFile/launchtime/%s_%s" % (self.timestr,AppLaunchTimeCSVFile)
    ...
    def GetData(self):
        self.data.update({'elapsedtimecold':self.elapsedtimecold})
        self.data.update({'elapsedtimehot':self.elapsedtimehot})
    ...
    def GetPicture(self):
        ...
        ylabel = '启动时间(单位：ms)'
        title = '冷热启动时间统计'
        picturefile = "./../dataFile/launchtime/%s_%s" % (self.timestr,AppLaunchTimePictureFile)
