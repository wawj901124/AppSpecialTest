...
class Controller(object):
    ...
    def TestProcessOnce(self):
        ...
        if len(result):
            ...
            self.traffic.append(alltraffic)
        else:
    ...
    def SaveDataToCSV(self):
        ...
        csvfile = "./../dataFile/traffic/%s_%s" % (self.timestr,AppTrafficCSVFile)
    ...
    def GetData(self):
        self.data.update({'traffic':self.traffic})
    ...
    def GetPicture(self):
        ...
        ylabel = '流量（单位：KB）'
        title = '流量统计'
        picturefile = "./../dataFile/traffic/%s_%s" % (self.timestr,AppTrafficPictureFile)
